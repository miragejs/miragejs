...
Creates or updates a model of type `type` in the store. `data` is a POJO. If `data` has an `id`, it updates the model in the store, otherwise it creates a new model.
