...
*/
module(
  "Unit | Serializers | JSON API Serializer | #_createIncludesGraphSnapshot models",
  function(hooks) {
    ...
    test("it works on models with belongsTo relationships", function(assert) {
      ...
      this.serializer.request = {
        queryParams: { include: "red-tag,blue-post" }
      };
    ...
    test("it works on models with hasMany relationships", function(assert) {
      ...
      this.serializer.request = {
        queryParams: { include: "red-tags,blue-posts" }
      };
