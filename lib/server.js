    ...
    return new Pretender(
      function() {
        ...
        this.unhandledRequest = function(verb, path) {
          path = decodeURI(path);
          assert(
            `Your app tried to ${verb} '${path}', but there was no route defined to handle this request. Defined a route for this endpoint in your baseConfig. Did you forget to define a namespace?`
          );
        };
      },
