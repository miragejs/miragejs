...
import { pick, assign, find, isPlainObject, isInteger } from "lodash-es";
...
export default class Server {
  ...
  config(config = {}) {
    ...
    */
    this.pretender =
      this.pretender || config.pretender || this.createPretender();
  ...
  passthrough(...paths) {
    ...
    verbs.forEach(verb => {
      paths.forEach(path => {
        ...
        // TODO: this is a directly calling pretender
  ...
  */
  ...
  shutdown() {
    ...
    if (this.environment === "test" && typeof window !== "undefined") {
      // TODO deal with window
