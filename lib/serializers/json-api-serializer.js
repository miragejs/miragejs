...
class JSONAPISerializer extends Serializer {
  ...
  getHashForResource(resource, isIncludedResource) {
    ...
    if (this.isModel(resource)) {
      ...
      hash = resource.models.map((m) =>
        this.getResourceObjectForModel(m, isIncludedResource)
      );
    }
  ...
  */
  ...
  getResourceObjectForModel(model, isIncludedResource) {
    ...
    return this._maybeAddRelationshipsToResourceObjectForModel(
      hash,
      model,
      isIncludedResource
    );
  ...
  _maybeAddRelationshipsToResourceObjectForModel(
    hash,
    model,
    isIncludedResource
  ) {
