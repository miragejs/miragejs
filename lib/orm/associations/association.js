...
export default class Association {
  constructor(modelName, opts) {
    /**
      ...
      Note that just like in this example, the `modelName` and the `name` can be different. This is because Mirage supports multiple relationships of the same type:
    ...
    */
    ...
    /**
      The name of the association, which comes from the property name that was used to define the association.
